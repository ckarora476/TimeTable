...
public class FacultyTimeTableHelper {
	...
	public static FacultyTimeTableResultSet[][] populateFacultyData(
		...
		String query = "SELECT DAY.DAY_ID AS DAY,SUBJECT_INFO.SUBJECT_NAME AS SUBJECT,LTP.NAME AS LTP,TIMESLOTS.START_TIME,TIMESLOTS.END_TIME,ROOM.ROOM_NO AS ROOM ,TUTGROUPS.PREFIX ||'-'||TUTGROUPS.NUM AS TUTGROUP "
				+ "FROM (((((((MASTER "
